...
def main():
    ...
    parser.add_argument('-model', type=str, default="aeroarms_hecatonquiros_positioner_gripper",
    ...
    # Xacro description must be in arm_description package
    #description_dir = rospack.get_path("arm_description")
    description_dir = rospack.get_path("arm_description")
